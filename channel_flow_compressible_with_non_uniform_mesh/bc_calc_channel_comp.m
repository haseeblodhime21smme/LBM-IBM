function fprop = bc_calc_channel_comp(u_inlet,f,fprop,u,NX,NY,cs,rho,cvec,cvec_w)

% Left

u_left_vec_arr = [u_inlet*ones(NY,1) zeros(NY,1)];
...
% Top
u_top_vec_arr = [u(1,:,1); zeros(1,NX)];
...
% Bottom
u_bot_vec_arr = [u(NY,:,1); zeros(1,NX)];
